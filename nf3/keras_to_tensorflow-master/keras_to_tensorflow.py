...
flags.DEFINE_string('input_model', r'EAST_IC15+13_model.hdf5', 'Path to the input model.')
flags.DEFINE_string('input_model_json',r'model.json', 'Path to the input model '
                                              'architecture in json format.')
flags.DEFINE_string('input_model_yaml', None, 'Path to the input model '
                                              'architecture in yaml format.')
flags.DEFINE_string('output_model',r'C:\Users\Legion\Downloads\thor.pb', 'Path where the converted model will '
                                          'be stored.')
